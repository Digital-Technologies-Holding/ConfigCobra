...
1. Press **"Add New Rule Set"** in the top right corner
   ...
   ![Create new rule set](../images/ConfigCobraApp/RuleSets/01_RuleSetCreate.png)

2. Give a **📝 name** and a **📄 description** for your rule set
3. Select the **⚙️ controls** that you want to add into the rule set from the available CIS Benchmarks

   ![Add name and select benchmarks or controls](../images/ConfigCobraApp/RuleSets/02_RuleSetAddNameAndSelectBenchmarksOrRulesets.png)

4. Press **"Add"** to create your rule set

### Step 4: ✏️ Edit an existing rule set
