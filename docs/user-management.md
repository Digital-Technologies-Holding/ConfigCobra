...
1. In the top right corner, select **"Add User"**
   ...
   ![Add user](../images/ConfigCobraApp/UserManagement/01_UserAdd.png)

2. 🔍 Search for the desired user in your Azure Entra directory

   ![Select user](../images/ConfigCobraApp/UserManagement/02_UserSelect.png)

3. On the left side, press **"Add"**
4. The button text changes to **"In Team"** and the user is added

**👁️ Default role:** New users are automatically assigned the **Global Reader** role by default. You can change this role in the actions menu.

### Step 4: ✏️ Change user role

To change a user's role:

1. In the **actions menu**, select the **edit icon** for the desired user
2. You can select from: **👑 Global Admin**, **🔧 Global Operator**, or **👁️ Global Reader**
3. Select the desired role and press **"Save"**

![Edit user](../images/ConfigCobraApp/UserManagement/03_UserEdit.png)

### Step 5: 🗑️ Delete a user
...
**🔐 Permissions:**
- ▶️ Run and schedule assessments
- 👀 View and download reports
- 📋 Create and manage rule sets
- ⚙️ Configure assessment settings
...
- **👁️ Grant Global Reader role** to stakeholders who only need to view reports and metrics
...
- **🛡️ Security** - Only users from your subscribed tenant can access ConfigCobra
